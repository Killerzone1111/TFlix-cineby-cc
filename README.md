...
TFlix is a TizenBrew module that transforms [Cineby.cc](https://www.cineby.cc/) into a TV-friendly experience for Samsung TVs. It creates a Netflix-like navigation system optimized for remote control operation.
...
- `mods/` - Contains the JavaScript modules for enhancing Cineby.cc
...
*TFlix is a community-created module for TizenBrew and is not officially affiliated with Cineby.cc.*
